...
set_target_properties(c10 PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "cpuinfo"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libc10.so.2.7.1"
  IMPORTED_SONAME_RELEASE "libc10.so.2.7"
  )

list(APPEND _cmake_import_check_targets c10 )
list(APPEND _cmake_import_check_files_for_c10 "${_IMPORT_PREFIX}/lib/libc10.so.2.7.1" )
...
set_target_properties(torch_cpu PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "pthreadpool;cpuinfo"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libtorch_cpu.so.2.7.1"
  IMPORTED_SONAME_RELEASE "libtorch_cpu.so.2.7"
  )

list(APPEND _cmake_import_check_targets torch_cpu )
list(APPEND _cmake_import_check_files_for_torch_cpu "${_IMPORT_PREFIX}/lib/libtorch_cpu.so.2.7.1" )
...
set_target_properties(torch PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libtorch.so.2.7.1"
  IMPORTED_SONAME_RELEASE "libtorch.so.2.7"
  )

list(APPEND _cmake_import_check_targets torch )
list(APPEND _cmake_import_check_files_for_torch "${_IMPORT_PREFIX}/lib/libtorch.so.2.7.1" )
