...
if(CMAKE_CUDA_COMPILER_LOADED) # CUDA as a language
  if(CMAKE_CUDA_COMPILER_ID STREQUAL "NVIDIA"
      ...
      OR CMAKE_CUDA_COMPILER_VERSION MATCHES "^([0-9]+\\.[0-9]+\\.[0-9]+)")
    set(CUDA_VERSION "${CMAKE_MATCH_1}")
    message(STATUS "CUDA_VERSION set to ${CUDA_VERSION}")
  endif()
endif()
...
function(CUDA_DETECT_INSTALLED_GPUS OUT_VARIABLE)
  if(NOT CUDA_GPU_DETECT_OUTPUT)
    ...
    if(run_result EQUAL 0)
      ...
      message(STATUS "Detected compute capabilities: ${CUDA_GPU_DETECT_OUTPUT}")
    endif()
    endif()
  ...
  if (NOT CUDA_GPU_DETECT_OUTPUT)
    set(CUDA_GPU_DETECT_OUTPUT "7.5;8.0;8.6;8.6+PTX;8.9;8.9+PTX;9.0;9.0a;10.0;10.0a;10.1;10.1a;10.5;12.0;12.0a")
  endif()
