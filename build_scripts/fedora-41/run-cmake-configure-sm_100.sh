...
cmake_flags="${cmake_flags} -DCUDA_ARCH_LIST:STRING=10.0\;10.0a"
cmake_flags="${cmake_flags} -DTORCH_CUDA_ARCH_LIST:STRING=10.0\;10.0a"
...
cmake_flags="${cmake_flags} -DCMAKE_CUDA_ARCHITECTURES:STRING=100;100a"
...
cmake_flags="${cmake_flags} -DCUTLASS_NVCC_ARCHS_ENABLED:STRING=100;100a"
