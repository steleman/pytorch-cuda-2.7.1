...
cmake_flags="${cmake_flags} -DCUDA_ARCH_LIST:STRING=10.1"
cmake_flags="${cmake_flags} -DTORCH_CUDA_ARCH_LIST:STRING=10.1"
...
cmake_flags="${cmake_flags} -DCMAKE_CUDA_ARCHITECTURES:STRING=101"
...
cmake_flags="${cmake_flags} -DCUTLASS_NVCC_ARCHS_ENABLED:STRING=101"
