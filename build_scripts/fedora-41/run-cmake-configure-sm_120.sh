...
cmake_flags="${cmake_flags} -DCUDA_ARCH_LIST:STRING=12.0\;12.0a"
cmake_flags="${cmake_flags} -DTORCH_CUDA_ARCH_LIST:STRING=12.0\;12.0a"
...
cmake_flags="${cmake_flags} -DCMAKE_CUDA_ARCHITECTURES:STRING=120;120a"
...
cmake_flags="${cmake_flags} -DCUTLASS_NVCC_ARCHS_ENABLED:STRING=120;120a"
