...
cmake_flags="${cmake_flags} -DCUDA_ARCH_LIST:STRING=8.9"
cmake_flags="${cmake_flags} -DTORCH_CUDA_ARCH_LIST:STRING=8.9"
...
cmake_flags="${cmake_flags} -DCUTLASS_NVCC_ARCHS_ENABLED:STRING=89"
